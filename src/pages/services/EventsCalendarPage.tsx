...
const EventsCalendarPage = () => {
  ...
  const events = [
    ...
    {
      title: 'Appointment (Shiloh)',
      color: '#f56565',
      start: setDate(1, -1),
      end: setDate(1, 3)
    },
    {
      title: 'Appointment (Josh Flanagan)',
      color: '#4299e1',
      start: setDate(1),
    ...
    {
      title: 'Appointment (Frank Corachi)',
      color: '#ed5564',
    ...
    {
      title: 'Cardiovascular Seminar',
      color: '#e9e165',
      start: setDate(3, -5),
      end: setDate(4),
      desc:
      'An analysis of heart beat abnormalities in patients over 65.'
      
    },
    {
      title: 'Med Student Orientation',
      color: '#e9e165',
